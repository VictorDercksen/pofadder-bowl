...
-- folder is what starts it). Pending on the hosted project as of 2026-09-19; second trigger after the
-- integration settings were saved (repository, working directory ".", production branch main).
